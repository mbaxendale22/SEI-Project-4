...
const handleChange = (e) => {
  ...
  return (
      ...
      <form onSubmit={handleSubmit} className= ' border-r-2 border-t-2 border-white shadow-md h-3/6 w-7/12 flex items-center justify-evenly flex-col'>
      ...
      <Link to='/register' className='pr-btn bg-opacity-95 w-1/4 mt-4'>Sign Up</Link>
      </div>
    </div>
  )
}
