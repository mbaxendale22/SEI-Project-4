...
from .views import HEDetailView, HEIndexView, HERecentView, HELastMonth, HEMonthlyTotal, HELargestExpense, HESpendingByCategory

urlpatterns = [
    path('recent/<int:house>/', HERecentView.as_view()),
    path('dates/', HELastMonth.as_view()),
    path('monthly/', HEMonthlyTotal.as_view()),
    path('category/', HESpendingByCategory.as_view()),
